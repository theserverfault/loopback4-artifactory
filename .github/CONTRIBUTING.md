...
If you've noticed a bug or have a question, [search the issue tracker](https://github.com/sourcefuse/loopback4-artifactory/issues) to see if
someone else in the community has already created a ticket. If not, go ahead and
[make one](https://github.com/sourcefuse/loopback4-artifactory/issues/new/choose)!
...
up to date with loopback4-artifactory's master branch:

```sh
git remote add upstream git@github.com:sourcefuse/loopback4-artifactory.git
git checkout master
